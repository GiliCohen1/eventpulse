...
INSERT INTO registrations (id, user_id, event_id, ticket_tier_id, status, registered_at) VALUES
  ...
  -- Extra demo tickets for main users
  ('f0000000-0000-0000-0000-000000000013', 'a0000000-0000-0000-0000-000000000001', 'e0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000007', 'confirmed', NOW() - INTERVAL '6 hours'),
  ('f0000000-0000-0000-0000-000000000014', 'a0000000-0000-0000-0000-000000000002', 'e0000000-0000-0000-0000-000000000008', 'd0000000-0000-0000-0000-000000000012', 'confirmed', NOW() - INTERVAL '12 hours')
...
INSERT INTO payments (registration_id, user_id, amount, currency, status, method, transaction_id, metadata, paid_at) VALUES
  ...
  ('f0000000-0000-0000-0000-000000000013', 'a0000000-0000-0000-0000-000000000001', 0.00, 'USD', 'completed', 'free', 'txn_free_master_001', '{}', NOW() - INTERVAL '6 hours'),
  ('f0000000-0000-0000-0000-000000000014', 'a0000000-0000-0000-0000-000000000002', 10.00, 'USD', 'completed', 'simulated_card', 'txn_sim_yoga_002', '{"last4":"1111","brand":"Visa"}', NOW() - INTERVAL '12 hours');
...
INSERT INTO tickets (registration_id, ticket_code, qr_code_data, is_used, issued_at) VALUES
  ...
  ('f0000000-0000-0000-0000-000000000013', 'EP-SMCL-0001', '{"reg":"f0000000-0000-0000-0000-000000000013","event":"e3","code":"EP-SMCL-0001"}', false, NOW() - INTERVAL '6 hours'),
  ('f0000000-0000-0000-0000-000000000014', 'EP-YOGA-0002', '{"reg":"f0000000-0000-0000-0000-000000000014","event":"e8","code":"EP-YOGA-0002"}', false, NOW() - INTERVAL '12 hours')
